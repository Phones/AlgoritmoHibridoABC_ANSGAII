...
class grafo:
    ...
    def __processa_nos(self):
        caminho_nodes = r'instancia1_nodes'
    ...
    def __processa_links(self,tipo_aresta):
        caminho_links = r'instancia1_links'
    ...
    def __processa_demands(self):
        caminho_demandas = r'instancia1_demands'
    ...
    def __processa_instancia(self,caminho):
        arq = open(caminho,'r')
        estado = 0
        arq_nos = open(r'instancia1_nodes','w')
        arq_links = open(r'instancia1_links','w')
        arq_demandas = open(r'instancia1_demands','w')
        print('uai')
        for linha in arq:
            if linha =='':
                continue
